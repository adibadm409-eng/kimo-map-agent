...
for (const marker of ['useAudioRecorder', 'const [attachments', 'DocumentPicker', 'handleSend', 'cancelAgent', 'إيقاف التسجيل وإرساله']) assert.ok(screen.includes(marker), `missing UI route: ${marker}`)
