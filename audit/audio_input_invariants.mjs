...
assert.match(screen, /accessibilityLabel=\{recorderState\.isRecording \? 'إيقاف التسجيل ومعاينته' : 'بدء الإدخال الصوتي'\}/)
assert.match(screen, /حذف التسجيل الصوتي/)
assert.match(screen, /إرسال التسجيل الصوتي/)
