// تحويل التسجيل الصوتي إلى نص قبل إرساله للنموذج. هذا يجعل الإدخال الصوتي
// يعمل مع أي مزوّد/موديل دون الاعتماد على دعم input_audio (الذي كان يسبب خطأ 400
// عند إرساله لمسارات لا تقبله). ندعم جيميني (عبر واجهته الأصلية) ومسترال
// (voxtral) وOpenAI (whisper)، ونتدهور بلطف عند عدم التوفر.
